...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Subject.groups'
        db.add_column('userextended_subject', 'groups', self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True), keep_default=False)

        # Deleting field 'Pupil.group'
        db.delete_column('userextended_pupil', 'group')


    def backwards(self, orm):
        
        # Deleting field 'Subject.groups'
        db.delete_column('userextended_subject', 'groups')

        # Adding field 'Pupil.group'
        db.add_column('userextended_pupil', 'group', self.gf('django.db.models.fields.CharField')(default='1', max_length=1), keep_default=False)
    ...
    models = {
        ...
        'userextended.pupilconnection': {
            'Meta': {'object_name': 'PupilConnection'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pupil': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['userextended.Pupil']"}),
