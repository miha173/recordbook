...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Notify.notify_start'
        db.add_column('userextended_notify', 'notify_start', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Notify.notify_start'
        db.delete_column('userextended_notify', 'notify_start')
