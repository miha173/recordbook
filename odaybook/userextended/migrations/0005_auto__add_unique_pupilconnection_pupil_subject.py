...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'PupilConnection', fields ['pupil', 'subject']
        db.create_unique('userextended_pupilconnection', ['pupil_id', 'subject_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'PupilConnection', fields ['pupil', 'subject']
        db.delete_unique('userextended_pupilconnection', ['pupil_id', 'subject_id'])
