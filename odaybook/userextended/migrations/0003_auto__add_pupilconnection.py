...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PupilConnection'
        db.create_table('userextended_pupilconnection', (
            ...
            ('value', self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True)),
        ))
        db.send_create_signal('userextended', ['PupilConnection'])


    def backwards(self, orm):
        
        # Deleting model 'PupilConnection'
        db.delete_table('userextended_pupilconnection')
