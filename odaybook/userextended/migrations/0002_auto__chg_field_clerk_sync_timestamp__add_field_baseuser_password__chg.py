...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Clerk.sync_timestamp'
        db.alter_column('userextended_clerk', 'sync_timestamp', self.gf('django.db.models.fields.IntegerField')())

        # Adding field 'BaseUser.password'
        db.add_column('userextended_baseuser', 'password', self.gf('django.db.models.fields.CharField')(default='', max_length=128), keep_default=False)

        # Changing field 'BaseUser.sync_timestamp'
        db.alter_column('userextended_baseuser', 'sync_timestamp', self.gf('django.db.models.fields.IntegerField')())


    def backwards(self, orm):
        
        # Changing field 'Clerk.sync_timestamp'
        db.alter_column('userextended_clerk', 'sync_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Deleting field 'BaseUser.password'
        db.delete_column('userextended_baseuser', 'password')

        # Changing field 'BaseUser.sync_timestamp'
        db.alter_column('userextended_baseuser', 'sync_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
    ...
    models = {
        ...
        'userextended.pupil': {
            ...
            'group': ('django.db.models.fields.CharField', [], {'default': "'1'", 'max_length': '1'}),
