...
#                       (r'pupil/delete/(?P<pupil_id>\d+)/$', 'pupilEdit', {'mode': 'delete'}),
                       ...
                       (r'^(?P<object>\w+)/$', 'objectList'),
                       (r'^(?P<object>\w+)/add/$', 'objectEdit', {'mode': 'add'}),
                       (r'^(?P<object>\w+)/edit/(?P<id>\d+)/$', 'objectEdit', {'mode': 'edit'}),
                       (r'^(?P<object>\w+)/delete/(?P<id>\d+)/$', 'objectEdit', {'mode': 'delete'}),
